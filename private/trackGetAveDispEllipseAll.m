function [longVecS,longVecE,shortVecS,shortVecE,shortVecS3D,shortVecE3D] = ...
    trackGetAveDispEllipseAll(xyzVel,brownStd,trackType,undetBrownStd,timeWindow,...
...
if nargin ~= nargin('trackGetAveDispEllipseAll')
    disp('--trackGetAveDispEllipseAll: Incorrect number of input arguments!');
    return
end
