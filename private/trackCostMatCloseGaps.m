function [costMat,nonlinkMarker,indxMerge,numMerge,indxSplit,numSplit,...
    errFlag] = trackCostMatCloseGaps(trackedFeatInfo,...
...
% TRACKCOSTMATCLOSEGAPS provides a cost matrix for closing gaps in tracking HeLa kinetochores
%
...
if nargin ~= nargin('trackCostMatCloseGaps')
    disp('--trackCostMatCloseGaps: Incorrect number of input arguments!');
    errFlag  = 1;
    return
end
...
[longVecSAll,longVecEAll,shortVecSAll,shortVecEAll,shortVecS3DAll,...
    shortVecE3DAll] = trackGetAveDispEllipseAll(xyzVel,noiseStd,trackType,...
