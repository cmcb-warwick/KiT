function dublQuickStats(intraStructure,varargin)
% DUBLQUICKSTATS Gives a list of statistics for delta measurements.
%
%    DUBLQUICKSTATS(INTRASTRUCTURE,...) Calculates the median, mean,
%    standard error and deviation, and number of measurements collated in
